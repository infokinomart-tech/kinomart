            ...
            return (
              ...
              >
                ...
                {activeDropdown === cat.id && (
                  <div className="absolute left-1/2 -translate-x-1/2 top-full mt-1 w-48 bg-[#0B241C] border border-[#183E31] rounded-xl shadow-xl p-2 z-50 animate-fadeIn">
                    <button
                      onClick={() => handleCategoryClick(cat.id)}
                      className="w-full text-left px-3 py-2 text-xs font-semibold text-amber-300 hover:bg-white/10 rounded-lg flex items-center justify-between transition-colors"
                    >
                    ...
                    <button
                      onClick={() => handleCategoryClick(cat.id)}
                      className="w-full text-left px-3 py-1.5 text-xs text-white/80 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                    >
                      পপুলার আইটেম
                    </button>
                    <button
