export const products = [
  ...
  },
  {
    ...
    description:
      '২০-৬৫ ওয়াট ইউনিভার্সাল ট্রাভেল অ্যাডাপ্টর যেটি আপনার যেকোনো ডিভাইস চার্জিং এর জন্য পারফেক্ট সলিউশন।',
    images: [
  ...
  },
  {
    ...
    slug: '20w-universal-travel-adapter',
    model: 'Black',
    price: 1290.0,
    originalPrice: 1550.0,
    sectionType: 'hot',
    ...
    description: 'এটি আপনার যেকোনো ডিভাইস চার্জিং এর জন্য পারফেক্ট সলিউশন।',
    images: [
